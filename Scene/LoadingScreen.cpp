...
{
	m_spriteBatch->Begin();
	m_spriteBatch->Draw(m_backSRV.Get(), SimpleMath::Vector2(0.0f, 0.0f), nullptr, DirectX::XMVECTOR{1.0f, 1.0f, 1.0f,0.9f}, 0.0f, SimpleMath::Vector2(0.0f, 0.0f), 1.0f, SpriteEffects_None);
...
void LoadingScreen::CreateDeviceDependentResources()
{
	...
	CreateWICTextureFromFile(device, L"Resources/Textures/mitudomoe.png", nullptr, LoadingScreen::m_SRV.ReleaseAndGetAddressOf());
	CreateWICTextureFromFile(device, L"Resources/Textures/back.png", nullptr, LoadingScreen::m_backSRV.ReleaseAndGetAddressOf());
	CreateWICTextureFromFile(device, L"Resources/Textures/Yomikomi.png", nullptr, LoadingScreen::m_moziSRV.ReleaseAndGetAddressOf());
